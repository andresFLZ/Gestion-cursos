...
public class ModificarGrupoIGU extends javax.swing.JFrame {

    Controlador controlador = null;
    Grupos grupo = null;
    
    public ModificarGrupoIGU(int id) {
    ...
    private void initComponents() {
        ...
        jLabelTitulo.setText("MODIFICAR GRUPO");
    ...
    private void jButtonGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonGuardarActionPerformed
        ...
        controlador.actualizarGrupo(this.grupo, jTextFieldNombre.getText(), jTextFieldHorario.getText(), profe, monitor);
    ...
    private void cargarDatos(int id) {
        this.grupo = controlador.retornarGrupo(id);
        
        jTextFieldNombre.setText(this.grupo.getNombre());
        jTextFieldHorario.setText(this.grupo.getHorario());
